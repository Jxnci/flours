<template>
  ...
  <section id="six">
    <div class="section-title">
      <h2>
        <a href="https://www.xyzzyestudioweb.com" target="_blank"
          >XYZZY estudio web</a
        >
      </h2>
      <h3>
        <a href="https://www.facebook.com/xyzzyestudioweb" target="_blank"
          >Facebook</a
        >
        <a href="https://www.linkedin.com/company/18970046/" target="_blank"
          >Linkedin</a
        >
      </h3>
    </div>
