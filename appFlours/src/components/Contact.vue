    ...
    <div class="container px-5 py-24 mx-auto flex">
      ...
      >
        ...
        <p class="leading-relaxed mb-5 text-gray-600">
          Tienes alguna duda, envia un mensaje o un comentario.
        </p>
        ...
        <button
          class="text-white bg-indigo-500 border-0 py-1 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
        >
          Enviar
        </button>
